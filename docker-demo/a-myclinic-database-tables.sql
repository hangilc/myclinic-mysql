...
--
-- Host: changclinic-db.c2d54s6bbvpi.ap-northeast-1.rds.amazonaws.com    Database: myclinic
-- ------------------------------------------------------
...
CREATE TABLE `app_event` (
  `app_event_id` int(11) NOT NULL AUTO_INCREMENT,
  `created_at` text NOT NULL,
  `model` text NOT NULL,
  `kind` text NOT NULL,
  `data` text NOT NULL,
  PRIMARY KEY (`app_event_id`)
...
CREATE TABLE `appoint` (
  ...
  `appoint_time_id` int(11) DEFAULT NULL,
  `patient_name` text NOT NULL,
  `patient_id` int(11) NOT NULL,
  `memo` text NOT NULL,
  PRIMARY KEY (`appoint_id`),
  KEY `appoint_time_id` (`appoint_time_id`),
  CONSTRAINT `appoint_ibfk_1` FOREIGN KEY (`appoint_time_id`) REFERENCES `appoint_time` (`appoint_time_id`)
...
CREATE TABLE `appoint_time` (
  `appoint_time_id` int(11) NOT NULL AUTO_INCREMENT,
  `date` text NOT NULL,
  `from_time` text NOT NULL,
  `until_time` text NOT NULL,
  `kind` text NOT NULL,
  `capacity` int(11) NOT NULL,
  PRIMARY KEY (`appoint_time_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=66862 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11202 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2052 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `hoken_shahokokuho` (
  ...
  `edaban` char(2) NOT NULL DEFAULT '',
  PRIMARY KEY (`shahokokuho_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11895 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=265950 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1418 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7664 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=411329 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=888 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary table structure for view `shinryou_view`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=109487 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_conduct` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1256 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_conduct_drug` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=465 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_conduct_kizai` (
  ...
  `amount` double NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=815 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_conduct_shinryou` (
  ...
  `shinryoucode` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1874 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_drug` (
  ...
  PRIMARY KEY (`drug_id`),
  KEY `visit_id` (`visit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=194911 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_shinryou` (
  ...
  PRIMARY KEY (`shinryou_id`),
  KEY `visit_id` (`visit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=733158 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visit_text` (
  ...
  PRIMARY KEY (`text_id`),
  KEY `visit_id` (`visit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=142115 DEFAULT CHARSET=cp932;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-12-05 11:57:56
